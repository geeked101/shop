// MERGE NOTE: Replace src/app/api/payouts/route.ts with this file.
// This uses the real Daraja B2C API instead of the mock.
//
// SETUP:
//   1. Go to https://developer.safaricom.co.ke
//   2. Get approved for B2C (Business to Customer) payments
//   3. Add to .env.local:
